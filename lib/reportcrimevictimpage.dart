...
class ReportCrimeVictimPage extends StatefulWidget {
  @override
  CrimeVictimcreenState createState() => CrimeVictimcreenState();
}

class CrimeVictimcreenState extends State<ReportCrimeVictimPage>
                              ...
                              new Flexible(
                                child: GestureDetector(
                                    onTap: () {
                                      ...
                                      Route route = MaterialPageRoute(builder: (context) => ReportWitnessCrimePage());
